  ...
  return (
    <div className='flex justify-center gap-12 py-5'>
     ...
     <div>
        ...
        <div className='p-7 mt-3 lg:mx-4 mx-auto bg-white rounded-2xl shadow-md lg:w-[27rem] w-fit'>
            {/* -------------------------------------first-------------------------------------- */}
            ...
            <input name="user_address" type='text' onChange={(e)=>{setAdrs(e.target.value)}} className=' hover:shadow-md lg:w-full w-fit p-3 mt-2 bg-white text-sm rounded-3xl text-gray-500' value={adrs}/>
            </div>
             {/* -------------------------------------second-------------------------------------- */}
             <div className='mt-6'>
            <p className='text-sm text-red-600 font-semibold '>Message</p>
            <textarea name="user_message" onChange={(e)=>{setMsg(e.target.value)}} value={msg} id="" className='hover:shadow-md text-gray-500 lg:w-full w-fit p-3 mt-2 bg-white text-xs rounded-3xl'></textarea>
            </div>
            <div className='lg:w-full w-fit lg:mx-0 mx-auto p-3 mt-3 bg-red-800 cursor-pointer hover:bg-red-500 text-sm text-center rounded-3xl'>
