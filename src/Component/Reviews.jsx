    ...
    <div className='pt-2 h-fit pb-6  mt-3'>
      ...
      <div className='flex gap-12 justify-center'>
        ...
        <div className='p-6 mt-8 bg-white text-center shadow-xl hover:border-b-2 hover:border-b-red-500'>
            <img src={quote} alt="quote" className='h-[3rem] m-auto' />
            ...
            <img src={reviewpic1} alt="reviewpic1" className='h-[4.5rem] rounded-full mt-6 m-auto'/>
            ...
            <div className='flex gap-2 justify-center mt-1'>
                <img src={Uae} alt="Uae" className='h-[1.7rem] w-[1.7rem] rounded-full '/>
         ...
         <div className='p-6 mt-8 bg-white text-center shadow-xl hover:border-b-2 hover:border-b-red-500'>
            ...
            <img src={reviewpic2} alt="reviewpic2" className='h-[4.5rem] rounded-full mt-6 m-auto'/>
            <div className='flex mt-3 justify-center'>
                <StarRateIcon className='p-1 text-orange-400'/>
                <StarRateIcon className='p-1 text-orange-400'/>
                <StarRateIcon className='p-1 text-orange-400'/>
            ...
            <div className='flex gap-2 justify-center mt-1'>
                <img src={china} alt="china" className='h-[1.7rem] w-[1.7rem] rounded-full '/>
         ...
         <div className='p-6 mt-8 bg-white text-center shadow-xl hover:border-b-2 hover:border-b-red-500'>
            ...
            <div className='flex gap-2 justify-center mt-1'>
                <img src={Saudia} alt="Saudia" className='h-[1.7rem] w-[1.7rem] rounded-full '/>
        ...
        <div className='p-6 mt-8 bg-white text-center shadow-xl hover:border-b-2 hover:border-b-red-500'>
            ...
            <img src={reviewpic4} alt="reviewpic4" className='h-[4.5rem] rounded-full mt-6 m-auto'/>
            <div className='flex mt-3 justify-center'>
                <StarRateIcon className='p-1 text-orange-400'/>
                <StarRateIcon className='p-1 text-orange-400'/>
                <StarRateIcon className='p-1 text-orange-400'/>
            ...
            <div className='flex gap-2 justify-center mt-1'>
                <img src={Canada} alt="Canada" className='h-[1.7rem] w-[1.7rem] rounded-full '/>
        ...
        <div className='p-6 mt-8 bg-white text-center shadow-xl hover:border-b-2 hover:border-b-red-500'>
            ...
            <img src={reviewpic5} alt="reviewpic5" className='h-[4.5rem] rounded-full mt-6 m-auto'/>
            <div className='flex mt-3 justify-center'>
                <StarRateIcon className='p-1 text-orange-400'/>
                <StarRateIcon className='p-1 text-orange-400'/>
                <StarRateIcon className='p-1 text-orange-400'/>
            ...
            <div className='flex gap-2 justify-center mt-1'>
                <img src={italy} alt="italy" className='h-[1.7rem] w-[1.7rem] rounded-full '/>
        ...
        <div className='p-6 mt-8 bg-white text-center shadow-xl hover:border-b-2 hover:border-b-red-500'>
            ...
            <img src={reviewpic6} alt="reviewpic6" className='h-[4.5rem] rounded-full mt-6 m-auto'/>
            <div className='flex mt-3 justify-center'>
                <StarRateIcon className='p-1 text-orange-400'/>
                <StarRateIcon className='p-1 text-orange-400'/>
                <StarRateIcon className='p-1 text-orange-400'/>
            ...
            <div className='flex gap-2 justify-center mt-1'>
                <img src={france} alt="france" className='h-[1.7rem] w-[1.7rem] rounded-full '/>
        ...
        <div className='p-6 mt-8 bg-white text-center shadow-xl hover:border-b-2 hover:border-b-red-500 mr-10'>
            ...
            <img src={reviewpic7} alt="reviewpic7" className='h-[4.5rem] rounded-full mt-6 m-auto'/>
            <div className='flex mt-3 justify-center'>
                <StarRateIcon className='p-1 text-orange-400'/>
                <StarRateIcon className='p-1 text-orange-400'/>
                <StarRateIcon className='p-1 text-orange-400'/>
            ...
            <div className='flex gap-2 justify-center mt-1'>
                <img src={sweden} alt="sweden" className='h-[1.7rem] w-[1.7rem] rounded-full '/>
