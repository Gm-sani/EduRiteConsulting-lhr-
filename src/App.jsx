...
import Box, { Box1, Box2 } from './Component/Box.jsx';
    ...
    <div className='bg-slate-50'>
      ...
      <Routes>
        ...
        <Route path='overview' element={<CompanyOverview/>}>
          ...
          <Route path='italy' element={<Box1 phone="92-309-2480468" email="eduriteconsulting1@gmail.com" location="lhr" pic={office1}/>}/>
